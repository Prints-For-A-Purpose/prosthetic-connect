      ...
      <Row css={{ justifyContent: "center" }}>
        ...
        >
          ...
          <Card.Body>
            <Row css={{ justifyContent: "space-evenly" }}>
              <Avatar
                ...
                zoomed
                bordered
                css={{ width: "25%", height: "auto", cursor: "pointer" }}
                onClick={() =>
          ...
          <Card.Body>
            ...
            <Row>
              <Col css={{ alignContent: "center" }}>
                <Text>Project Manager</Text>
                <Spacer y={0.5}></Spacer>
                <Row>
                  <a href="https://github.com/jcp215033" target="_blank">
                    <svg
                      width={30}
                      height={30}
                      viewBox="0 0 20 20"
                  ...
                  <Spacer x={0.5}></Spacer>
                  <a
                    href="https://www.linkedin.com/in/castro-julian/"
                    target="_blank"
                  >
                    <svg
                      width={36}
              ...
              <Col>
                ...
                <Row>
                  <a
                    href="https://github.com/professionaljared"
                    target="_blank"
                  >
                    <svg
                      width={30}
                  ...
                  <Spacer x={0.5}></Spacer>
                  <a
                    href="https://www.linkedin.com/in/jaredknight0/"
                    target="_blank"
                  >
                    <svg
                      width={36}
              ...
              <Col>
                ...
                <Spacer y={0.5}></Spacer>
                <Row>
                  <a href="https://github.com/JackieGL" target="_blank">
                    <svg
                      width={30}
                      height={30}
                      viewBox="0 0 20 20"
                  ...
                  <Spacer x={0.5}></Spacer>
                  <a
                    href="https://www.linkedin.com/in/jackiegl/"
                    target="_blank"
                  >
                    <svg
                      width={36}
              ...
              <Col>
                ...
                <Spacer y={0.5}></Spacer>
                <Row>
                  <a href="https://github.com/gnatalie22" target="_blank">
                    <svg
                      width={30}
                      height={30}
                      viewBox="0 0 20 20"
                  ...
                  <Spacer x={0.5}></Spacer>
                  <a
                    href="https://www.linkedin.com/in/natalie-garcia000/"
                    target="_blank"
                  >
                    <svg
                      width={36}
