...
export default function NewRequestInfo({
  request,
  currentUser,
  setStatus,
  setErrorText,
            ...
            <Grid>
              <Collapse.Group shadow accordion={false}>
                ...
                <Collapse
                  ...
                  subtitle={
                    <Text h5>How many Fabricators do you think you need?</Text>
                  }
                  contentLeft={
                    <Avatar
                      size="lg"
                ...
                {authorized && (
                  <Collapse
                    title={
                      <Text h3 color="secondary">
                        Edit Or Delete Your
                        Requestㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ
                      </Text>
                    }
                    expanded
                    contentLeft={
