      ...
      <Row css={{ justifyContent: "center" }}>
        ...
        >
          <Collapse.Group shadow accordion={false}>
            ...
            >
              {buttonVisibility && (
                <Text h4>{newContent.q1_disability_info}</Text>
              )}
              {formVisibility && (
                <div>
                  <Textarea
            ...
            >
              {buttonVisibility && (
                <Text h4>{newContent.q2_functional_requirements}</Text>
              )}
              {formVisibility && (
                <div>
                  <Textarea
            ...
            >
              {buttonVisibility && (
                <Text h4>{newContent.q3_physical_specifications}</Text>
              )}
              {formVisibility && (
                <div>
                  <Textarea
            ...
            >
              {buttonVisibility && (
                <Text h4>{newContent.q4_lifestyle_usage}</Text>
              )}
              {formVisibility && (
                <div>
                  <Textarea
            ...
            <Collapse
              ...
              subtitle={
                <Text h3>
                  Do you have any requests, concerns, or preferences that can
                  help us create your item?
                </Text>
              }
              arrowIcon={
                <svg
            ...
            >
              {buttonVisibility && <Text h4>{newContent.q5_additional}</Text>}
              {formVisibility && (
                <div x>
                  <Textarea
                    // css={{ mw: "80%" }}
            ...
            <Collapse
              ...
              subtitle={
                <Text h3>What category of item do you think you need?</Text>
              }
              contentLeft={
                <Avatar
                  zoomed
            ...
            <Collapse
              ...
              subtitle={
                <Text h3>
                  How many Fabricators do you think you need?
